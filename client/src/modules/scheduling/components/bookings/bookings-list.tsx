...
import type { AttendeeStatus } from "../calendar/types";

type BookingWithStatuses = Booking & {
...
export function BookingsList({ bookings }: BookingsListProps) {
    ...
    const cancelMutation = useMutation(
        trpc.scheduling.cancelBooking.mutationOptions({
            onSuccess: () => {
                queryClient.invalidateQueries({
                    queryKey: trpc.scheduling.getUserBookings.queryKey(),
                });
                            ...
                            <Card key={booking.id} className="overflow-hidden">
                                <CardContent className="p-0">
                                    <div className="flex flex-col md:flex-row">
                                        {/* Date column */}
                                        <div
                                            className={`flex flex-col items-center justify-center p-4 md:p-6 md:w-32 ${isTodayBooking
